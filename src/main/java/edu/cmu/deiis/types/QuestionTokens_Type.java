...
public class QuestionTokens_Type extends Annotation_Type {
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (QuestionTokens_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = QuestionTokens_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new QuestionTokens(addr, QuestionTokens_Type.this);
  			   QuestionTokens_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new QuestionTokens(addr, QuestionTokens_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = QuestionTokens.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.deiis.types.QuestionTokens");
  ...
  public int getTokens(int addr) {
      ...
      jcas.throwFeatMissing("tokens", "edu.cmu.deiis.types.QuestionTokens");
  ...
  public int getQuestion(int addr) {
      ...
      jcas.throwFeatMissing("question", "edu.cmu.deiis.types.QuestionTokens");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public QuestionTokens_Type(JCas jcas, Type casType) {
    super(jcas, casType);
